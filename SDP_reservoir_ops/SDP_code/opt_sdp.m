function H = opt_sdp( tol, max_iter, sys_param, runParam, costParam)
...
while diff_H >= tol
    ...
    for t = T:-1:1
        ...
        for i = 1: n_s
            ...
            sys_param.simulation.VV = max_rel( i, :, t );
            H(i,t) = Bellman_sdp( H_, discr_s(i), t, sys_param, runParam, costParam);
        end
    end
    diff_H = max( max(abs( H_old - H )));
    count  = count+1;
